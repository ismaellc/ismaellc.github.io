...
//var material= new THREE.MeshNormalMaterial();
 //Para generar una forma combinada se requiere de las mallas poaras poder desplazar las formas en el espacio virtual
  ...
  this.PieIzq = new THREE.Mesh(new THREE.SphereGeometry(0.5),new THREE.MeshLambertMaterial({color: '#ffffff'}));//pie izquierdo
  //this.PieDer = new THREE.Mesh(new THREE.SphereGeometry(0.5));//pie derecho
  this.PiernIzq = new THREE.Mesh(new THREE.CylinderGeometry(0.5,0.5,4),new THREE.MeshLambertMaterial({color: '#ffffff'}));//pierna izq
...
function setup(){
  ...
  var ManIzq = new THREE.Mesh(new THREE.SphereGeometry(0.5),new THREE.MeshLambertMaterial({color: '#ffffff'}));//mano isq
  var ManDer = new THREE.Mesh(new THREE.SphereGeometry(0.5),new THREE.MeshLambertMaterial({color: '#ffffff'}));//mano derecha
  var HombIzq = new THREE.Mesh(new THREE.SphereGeometry(0.5),new THREE.MeshLambertMaterial({color: '#ffffff'}));//hombro isq
  var HombDer = new THREE.Mesh(new THREE.SphereGeometry(0.5),new THREE.MeshLambertMaterial({color: '#ffffff'}));//hombro derecha
  var Cabeza = new THREE.Mesh(new THREE.SphereGeometry(1.25),new THREE.MeshLambertMaterial({color: '#ffffff'}));//cabeza
  var Torso = new THREE.Mesh( new THREE.CylinderGeometry(2,1,3.5),new THREE.MeshLambertMaterial({color: '#ffffff'}));//torso
  var Cadera = new THREE.Mesh(new THREE.CylinderGeometry(1,2.5,2),new THREE.MeshLambertMaterial({color: '#ffffff'}));//cadera
 
  var BrazIzq = new THREE.Mesh(new THREE.CylinderGeometry(0.5,0.5,4),new THREE.MeshLambertMaterial({color: '#ffffff'}));//brazo isq
  var BrazDer = new THREE.Mesh(new THREE.CylinderGeometry(0.5,0.5,4),new THREE.MeshLambertMaterial({color: '#ffffff'}));//brazo derecho
  var Cuello = new THREE.Mesh(new THREE.CylinderGeometry(0.3,0.3,2),new THREE.MeshLambertMaterial({color: '#ffffff'}));//cuello
